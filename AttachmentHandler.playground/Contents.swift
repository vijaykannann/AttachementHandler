...
class AttachmentHandler: NSObject {
  ...
  func actionSheet(with attachmentMenu: AttachmentMenu) {
    ...
    if self.actionSheetController == nil {
      self.actionSheetController = UIAlertController(title: "", message: "", preferredStyle: .actionSheet)
      let cancelAction: UIAlertAction = UIAlertAction(title: "", style: .cancel) { _ -> Void in
      }
    ...
    switch attachmentMenu {
      case .camera:
        ...
        let takePictureAction: UIAlertAction = UIAlertAction(title: "", style: .default) { _ -> Void in
      ...
      case .photoLibrary:
        ...
        let choosePictureAction: UIAlertAction = UIAlertAction(title: "", style: .default) { _ -> Void in
      ...
      case .video:
        ...
        let chooseVideoAction: UIAlertAction = UIAlertAction(title: "", style: .default) { _ -> Void in
      ...
      case .document:
        ...
        let chooseFileAction: UIAlertAction = UIAlertAction(title: "", style: .default) { _ -> Void in
          self.documentPicker()
        }
